...
// Paris
void createTrafficObjects_Paris(std::vector<std::shared_ptr<Street>> &streets, std::vector<std::shared_ptr<Intersection>> & , std::vector<std::shared_ptr<Vehicle>> &vehicles, std::string &filename, int nVehicles)
{
